...
import pt.morais.holoshop.hologram.packetreader.PacketReader_V1_13_2;
...
public class PacketHologram_V1_13_2 implements PacketHologram {

    private final PacketReader_V1_13_2 packetReader = new PacketReader_V1_13_2();
    private final Player player;
    private final Hologram hologram;
    private final HashMap<Integer, EntityArmorStand> entityArmorStands = new HashMap<>();

    public PacketHologram_V1_13_2(Player player, Hologram hologram) {
        this.player = player;
