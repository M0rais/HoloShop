...
import pt.morais.holoshop.hologram.packetreader.PacketReader_V1_15_1;
...
public class PacketHologram_V1_15_1 implements PacketHologram {

    private final PacketReader_V1_15_1 packetReader = new PacketReader_V1_15_1();
    private final Player player;
    private final Hologram hologram;
    private final HashMap<Integer, EntityArmorStand> entityArmorStands = new HashMap<>();

    public PacketHologram_V1_15_1(Player player, Hologram hologram) {
        this.player = player;
    ...
    public void show() {
        ...
        PacketReader_V1_15_1 packetReader = new PacketReader_V1_15_1();
